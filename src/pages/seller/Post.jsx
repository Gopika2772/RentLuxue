...
import { registerProperty } from '../../axios/seller.axios';
...
const Post = ({user}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await registerProperty(formData, token, user.user_id);
      if (response.data) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-gray-100">
      <div className="w-full max-w-lg p-8 bg-white rounded-lg shadow-md">
        <h1 className="mb-6 text-2xl font-bold text-center">Rent Your Property</h1>
